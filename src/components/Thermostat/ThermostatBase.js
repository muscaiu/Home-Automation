...
class ThermostatBase extends React.Component {
  getStyles() {
  ...
  render() {
    ...
    return React.createElement(
      ...
      React.createElement('circle', { cx: radius, cy: radius, r: radius, style: styles.circle }),
      React.createElement(
        'g',
        null,
        tickArray
      ...
      React.createElement(
        'text',
        { x: radius, y: radius, style: styles.away },
        'AWAY'
      ),
      React.createElement('path', {
        d: leafDef, style: styles.leaf,
